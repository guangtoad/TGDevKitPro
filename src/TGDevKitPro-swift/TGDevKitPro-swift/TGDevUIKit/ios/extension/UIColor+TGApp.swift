...
public extension UIColor {
    ...
    struct Theme {
        static var textColor: UIColor  {
            return UIColor(named: "color_text") ?? UIColor.black
        }
        static var viewColor: UIColor {
            return UIColor(named: "color_background") ?? UIColor.black
        }
        static var lineColor: UIColor {
            return UIColor(named: "color_line") ?? UIColor.black
        }
    }
}
...
extension UIColor.Color{
    var localizedDescription: UIColor {
        switch self {
        case .view:
