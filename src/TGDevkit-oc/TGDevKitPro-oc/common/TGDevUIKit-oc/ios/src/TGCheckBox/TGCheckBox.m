...
//    t_action = action;
//}
- (void) setCheckedImage:(UIImage *)cImage uncheckImage:(UIImage *)uImage{
    [self setImage:cImage forState:UIControlStateSelected];
    [self setImage:uImage forState:UIControlStateNormal];
}
