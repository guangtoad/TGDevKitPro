...
public class TGStringUtil{
     ...
     * 默认字符串字
     */
    final static public String defaultStrValue = "";
    /***
     * 默认整数值
     */
    final static public int defaultIntValue = 0;
    /***
     * 默认布尔值
     */
    final static public boolean defaultBooleanValue = false;
    /***
     * 默认时间格式
     */
    final static public String defaultDataFormat = "yyyy-MM-DD HH:SS";
    ...
    public static Date dateValue(String str){
        return dateValue(str, defaultDataFormat, new Date());
    }
    ...
    public static String stringValue(Object obj){
        return stringValue(obj, defaultStrValue);
    }
    ...
    public static int intValue(String str){
        return intValue(str, defaultIntValue);
    }
    ...
    public static boolean booleanValue(String str){
        return booleanValue(str, defaultBooleanValue);
    }
